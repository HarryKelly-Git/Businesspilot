    ...
    <div className="w-full">
      ...
      <div className="relative">
        ...
        <input
          id={inputId}
          className={cn(
            'w-full rounded-lg border border-input bg-background px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-all duration-200',
            icon && 'pl-10',
  ...
  return (
    <div className="w-full">
      ...
      <textarea
        id={textareaId}
        className={cn(
          'w-full rounded-lg border border-input bg-background px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-all duration-200 min-h-[100px] resize-y',
          error && 'border-destructive focus:ring-destructive',
          className
        )}
        {...props}
  ...
  return (
    <div className="w-full">
      ...
      <select
        id={selectId}
        className={cn(
          'w-full rounded-lg border border-input bg-background px-4 py-3 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent transition-all duration-200',
          error && 'border-destructive focus:ring-destructive',
          className
        )}
        {...props}
